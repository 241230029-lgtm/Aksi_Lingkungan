...
<div class="pb-6 mb-6 border-b border-gray-100">
    ...
    <p class="text-sm text-gray-500 mt-1">Selamat datang kembali! Berikut ringkasan statistik aplikasi Aksi Lingkungan Anda.</p>
</div>
    ...
    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition">
        <div class="flex items-center justify-between">
            <div>
                ...
                <span class="text-xs font-medium text-green-600 inline-flex items-center gap-1 mt-1">Terverifikasi</span>
            </div>
    ...
    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition">
        <div class="flex items-center justify-between">
            <div>
                ...
                <span class="text-xs font-medium text-blue-600 inline-flex items-center gap-1 mt-1">Aksi Lingkungan</span>
            </div>
    ...
    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition">
        <div class="flex items-center justify-between">
            <div>
                ...
                <span class="text-xs font-medium text-purple-600 inline-flex items-center gap-1 mt-1">Topik Berbagi</span>
            </div>
    ...
    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition">
        <div class="flex items-center justify-between">
            <div>
                ...
                <span class="text-xs font-medium text-amber-600 inline-flex items-center gap-1 mt-1">Edukasi</span>
            </div>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-100 text-gray-700">
                    ...
                    <tr class="hover:bg-gray-50/50 transition">
                        ...
                        <td class="py-3.5 px-6 text-gray-500 text-xs">{{ $kg->created_at->format('d M Y') }}</td>
                        <td class="py-3.5 px-6 text-center">
                            <span class="px-2.5 py-1 rounded-full text-xs font-bold bg-green-50 text-green-700 border border-green-100">{{ $kg->status }}</span>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="3" class="py-6 text-center text-gray-400 italic">Belum ada kegiatan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm h-fit">
        ...
        <div class="grid grid-cols-1 gap-3">
            <a href="{{ route('admin.users') }}" class="flex items-center justify-between p-3.5 bg-gray-50 hover:bg-green-50 rounded-xl border border-gray-100 hover:border-green-200 text-sm font-semibold text-gray-700 hover:text-green-700 transition">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center text-green-600 text-xs font-bold">U</div>
                    <span>Kelola Masyarakat</span>
                </div>
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7-7"/>
            </a>
            ...
            <a href="{{ route('admin.kegiatan') }}" class="flex items-center justify-between p-3.5 bg-gray-50 hover:bg-blue-50 rounded-xl border border-gray-100 hover:border-blue-200 text-sm font-semibold text-gray-700 hover:text-blue-700 transition">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600 text-xs font-bold">K</div>
