...
<section class="bg-gradient-to-br from-green-600 to-green-700 py-24">
<div class="max-w-4xl mx-auto px-6 text-center">
    ...
    <h1 class="text-4xl md:text-5xl font-extrabold text-white mt-5">Tentang Aksi Lingkungan</h1>
    <p class="text-green-100 mt-5 max-w-2xl mx-auto leading-relaxed">
